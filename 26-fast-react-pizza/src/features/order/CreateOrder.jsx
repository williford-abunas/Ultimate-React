    ...
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex gap-2 flex-col sm:flex-row sm:items-center">
          ...
          {formErrors?.phone && <p className="text-xs text-red-700 mt-2 bg-red-100 p-2 rounded-md">{formErrors.phone}</p>}
        </div>
        ...
        <div className="mb-5 flex gap-2 flex-col sm:flex-row sm:items-center relative">
          ...
          {addressStatus === 'error' && <p className="text-xs text-red-700 mt-2 bg-red-100 p-2 rounded-md">{errorAddress}</p>}

          </div>
         {!position.latitude && !position.longitude && <span className="absolute right-[3px] top-[35px] md:right-[5px] md:top-[5px] sm:right-[5px] sm:top-[3px] z-50">
